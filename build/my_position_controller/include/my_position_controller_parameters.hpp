#pragma message("#include \"my_position_controller_parameters.hpp\" is deprecated. Use #include <my_position_controller/my_position_controller_parameters.hpp> instead.")
...
#include "validate_my_position_controller_parameters.hpp"
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("my_position_controller"), prefix) {
